...
public class FloatingActionsMenu extends ViewGroup {
    ...
    public void isDraggable(boolean isDraggable) {
        ...
        if (mFloatingActionButton != null) {
            mFloatingActionButton.isDraggable(isDraggable);
        }
    }
    ...
    private void init(@NonNull Context context, AttributeSet attributeSet) {
        ...
        mButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_fam_ButtonColorNormal, getColor(android.R.color.holo_blue_dark));
        mButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_fam_ButtonColorPressed, getColor(android.R.color.holo_blue_light));
        mButtonSize = attr.getInt(R.styleable.FloatingActionsMenu_fam_ButtonSize, FloatingActionButton.SIZE_NORMAL);
        ...
        isDraggable = attr.getBoolean(R.styleable.FloatingActionsMenu_fam_isDraggable, false);
        attr.recycle();
